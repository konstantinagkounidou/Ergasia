...
<body bgcolor="skyblue">
	...
	<form action="insert_product.php" method="post" enctype="multipart/form-data"> 
		...
		echo "<option value='$cat_id'>$cat_title</option>";
			...
			<tr>
				<td align="right"><b>Απόθεμα Προιόντος:</b></td>
...
<?php 
	...
	if(isset($_POST['insert_post'])){
		...
		move_uploaded_file($product_image_tmp,"product_images/$product_image");
		 ...
		 $insert_product = "insert into products (product_cat,product_title,product_price,product_desc,product_image,product_keywords,stock) values ('$product_cat','$product_title','$product_price','$product_desc','$product_image','$product_keywords','$product_stock')";
